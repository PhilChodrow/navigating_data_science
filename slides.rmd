...
<div class = 'fragment'>
```{r, out.height = 350, out.width = 500,  echo = FALSE, fig.align='center'}
...
1. Open the file `my_dashboard.html`. There is a commentary box which you will fill in with your own analysis of our findings. 
2. Open `my_dashboard.rmd`. Locate the block of text at the end of the file, and replace it with your analysis. 
3. "Knit" the file using the button at the top of the RStudio script editor window. The result (after a few moments) is a new copy of `my_dashboard.html` containing your analysis. Submit this file. 
